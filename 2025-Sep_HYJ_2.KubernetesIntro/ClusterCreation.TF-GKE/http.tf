...
resource "google_compute_region_url_map" "default" {
  ...
  # Pulled from example: https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_region_url_map#example-usage---region-url-map-l7-ilb-path
